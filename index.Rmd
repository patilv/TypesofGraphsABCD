...
library(dplyr)
library(choroplethr)
opts_chunk$set(echo=FALSE, warning=FALSE, message=FALSE, fig.width=14, fig.height=7)# width=14
```
...
```{r echo=FALSE, warning=FALSE,message=FALSE}
choroplethr(df_president,lod="state",title="2012 US Presidential Results",renderAsInsets=F)+ geom_point(data=bcities,aes(x=lon,y=lat,group=NULL))
```
